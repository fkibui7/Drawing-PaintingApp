...
const drawRect = (e) => {
    // if fillColor isn't checked draw a rect with border elsedraw rect with background
...
const drawTriangle = (e) => {
    ...
    ctx.closePath(); // closing path of triangle so the ehird line draw automatically
...
const startDraw = (e) => {
    ...
    ctx.fillStyle = selectedColor; // passing selectedColor as fill stlyle
...
const drawing = (e) => {
    ...
    if(selectedTool === "brush" || selectedTool === "eraser") {
        ...
        // to paint white color onto the existing canvas content else set the stroke color to selected color
...
colorBtns.forEach(btn => {
    btn.addEventListener("click", () => { // adidng click event to all color button
         // removing active class from the previous option and adding on current clicked option
